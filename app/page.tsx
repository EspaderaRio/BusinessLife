...
export default function DashboardPage() {
  ...
  // 💡 Always render modal at root so it appears when no player exists
  if (!player) {
    return (
      <main className="p-6 text-center text-white">
        ...
        {/* No need for Start Game button — modal handles that */}
      </main>
    );
  }
  ...
  return (
    <main className="p-6 grid gap-6 text-white">
      ...
      <div className="flex justify-center mt-4">
        <Button onClick={nextYear} className="px-8 py-3 text-lg">
          Next Year
        </Button>
      </div>
    </main>
